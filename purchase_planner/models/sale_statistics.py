...
class Statistics_sell (models.Models):
    ...
    def get_sales_product(self, date_orders):
            ...
            req = (
                ...
                " to_char(CAST(sale.date_order as date), 'MON') || '-' || CAST((extract('day' from date_trunc('week', CAST(sale.date_order as date)) -   date_trunc('week', date_trunc('month', CAST(sale.date_order as date)))) / 7 + 1) as char) as week_name ," +
